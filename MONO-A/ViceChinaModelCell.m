...
#import "ViceChinaModelCell.h"

@implementation ViceChinaModelCell
...
- (void)calculateHeight
{
    ...
    //改变cintentView的frame
        ...
        self.frame = CGRectMake(self.frame.origin.x, self.frame.origin.y, self.frame.size.width,  self.imaView.frame.size.height  + 4 *kSpace ) ;
